                    ...
                    >
                        <SwiperSlide className="hero-slide">
                            <div className="hero-slide-inner" style={{backgroundImage: `url(${SliderImage1})`}}>
                                <div className="hero-slide-content">
                                    <h1 className="c-dark">Human Resources isn't a thing we do It's the thing that runs your business.</h1>
                        ...
                        <SwiperSlide className="hero-slide">
                            <div className="hero-slide-inner" style={{backgroundImage: `url(${SliderImage2})`}}>
                                <div className="hero-slide-content">
                                    <h1 className="c-dark">You need to have a collabrative hiring process.</h1>
                                    {/* <div className="button-group">
                                        <VideoLightBox
                                            icon="far fa-play-circle"
                                            text="watch our video"
                        ...
                        <SwiperSlide className="hero-slide">
                            <div className="hero-slide-inner" style={{backgroundImage: `url(${SliderImage3})`}}>
                                <div className="hero-slide-content">
                                    <h1 className="c-dark">Focus on being productive instead of busy in payroll.</h1>
                                    {/* <div className="button-group">
                                        <VideoLightBox
                                            icon="far fa-play-circle"
                                            text="watch our video"
                        ...
                        <SwiperSlide className="hero-slide">
                            <div className="hero-slide-inner" style={{backgroundImage: `url(${SliderImage4})`}}>
                                <div className="hero-slide-content">
                                    <h1 className="c-dark">Corporate culture matters. How managment chooses to treat its people impacts everything for better or for worse.</h1>
                                    {/* <div className="button-group">
                                        <VideoLightBox
                                            icon="far fa-play-circle"
                                            text="watch our video"
